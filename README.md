...
* **Momento Atual:** Desenvolvedor Full stack em atuação prática na **Place Tecnologia e Inovação** (início em 01/06).  
...
* **Diferencial:** Background em vendas (SDR e consultor) e áreas técnicas (Zootecnia e biotecnologia), com forte capacidade de entender regras de negócio e traduzir problemas reais em soluções técnicas eficientes.
...
![REST API](https://img.shields.io/badge/API-RESTful-%23007ACC.svg?style=for-the-badge)
...
- Arquitetura Backend (Node.js e Java)  
